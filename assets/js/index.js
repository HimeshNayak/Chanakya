...
eval(
  (function (p, a, c, k, e, d) {
    ...
    'N c=["\\J\\P\\w\\a\\W\\p\\J\\D\\o\\D\\f\\A\\m\\e\\w\\u\\P\\V\\K\\X\\C\\x\\b\\w\\I\\Y\\U\\Z\\D\\d\\r\\10\\A\\l\\S\\u\\y\\u\\R","\\g\\t\\a\\n\\a\\z\\p\\a\\l\\a\\d\\b\\h\\i\\q\\F\\f\\C\\k\\d\\a\\m\\k\\a\\e\\e\\q\\g\\v\\y","\\t\\o\\o\\e\\m\\B\\L\\L\\g\\t\\a\\n\\a\\z\\p\\a\\l\\a\\d\\b\\h\\i\\q\\F\\f\\C\\k\\d\\a\\m\\k\\f\\v\\q\\g\\v\\y","\\g\\t\\a\\n\\a\\z\\p\\a\\l\\a\\d\\b\\h\\i","\\g\\t\\a\\n\\a\\z\\p\\a\\l\\a\\d\\b\\h\\i\\q\\a\\e\\e\\m\\e\\v\\o\\q\\g\\v\\y","\\b\\j\\i\\r\\s\\j\\h\\b\\A\\j\\b\\H","\\i\\B\\b\\j\\i\\r\\s\\j\\h\\b\\A\\j\\b\\H\\B\\11\\k\\d\\B\\j\\d\\G\\h\\s\\s\\G\\k\\r\\F\\x\\a\\h\\d\\b\\x\\E\\x\\i\\a\\H\\s","\\I\\l\\r\\17\\18\\19\\E\\u\\G\\I\\u\\E","\\f\\n\\f\\o\\f\\a\\K\\f\\w\\k\\J\\e\\e","\\a\\n\\a\\K\\p\\o\\f\\g\\m"];N O={13:c[0],16:c[1],15:c[2],14:c[3],12:c[4],1a:c[5],Q:c[6],T:c[7]};M[c[8]](O);M[c[9]]()',
    62,
    73,
    "||||||||||x61|x35|_0xe225|x62|x70|x69|x63|x34|x31|x39|x65|x2D|x73|x6E|x74|x79|x2E|x33|x37|x68|x4C|x6F|x7A|x64|x6D|x6B|x38|x3A|x72|x76|x36|x66|x32|x30|x47|x41|x6C|x2F|firebase|var|firebaseConfig|x49|appId|x45|x48|measurementId|x42|x56|x53|x59|x67|x4F|x54|x77|storageBucket|apiKey|projectId|databaseURL|authDomain|x5A|x4E|x52|messagingSenderId".split(
      "|"
    ),
    0,
    {}
...
function login() {
  ...
  firebase
    .auth()
    .signInWithEmailAndPassword(user_email_id, user_password)
...
function signIn() {
  ...
  firebase
    .auth()
    .createUserWithEmailAndPassword(user_email_id, user_password)
    .catch(function (error) {
      // Handle Errors here.
      var errorCode = error.code;
      var errorMessage = error.message;
...
function nameEntered() {
  ...
  if (name == "") console.log("Enter your name!!!");
  else {
